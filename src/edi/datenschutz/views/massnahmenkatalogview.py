...
class Massnahmenkatalogview(BrowserView):
    ...
    def verfuegbarkeit_title(self):
        ...
        return verfuegbarkeit_title

    def verfuegbarkeit_orgatechnisch(self):
        objects = []
        verfuegbarkeit_orgatechnisch = []
        ...
        return verfuegbarkeit_orgatechnisch

    def verfuegbarkeit_ansprechpartner(self):
        objects = []
        verfuegbarkeit_ansprechpartner = []
        ...
        return verfuegbarkeit_ansprechpartner
    ...
    def verfuegbarkeit(self):
        ...
        for i in objects:
            for object in i.zielerfuellung:
                if(object == 'verfuegbarkeit'):
                    dict['id'].append(i.id_massnahme)
                    dict['title'].append(i.title)
                    dict['orgatechnisch'].append(i.art_der_massnahme)
                    dict['ansprechpartner'].append(i.ausfuehrender)
