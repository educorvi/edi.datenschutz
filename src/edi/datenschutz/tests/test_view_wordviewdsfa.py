...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_wordviewdsfa_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='wordviewdsfa'
        )
        self.assertTrue(view.__name__ == 'wordviewdsfa')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in wordviewdsfa'
        # )

    def test_wordviewdsfa_not_matching_interface(self):
