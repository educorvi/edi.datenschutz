...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_dsfaview_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='dsfaview'
        )
        self.assertTrue(view.__name__ == 'dsfaview')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in dsfaview'
        # )

    def test_dsfaview_not_matching_interface(self):
