...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_massnahmeview_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='massnahmeview'
        )
        self.assertTrue(view.__name__ == 'massnahmeview')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in massnahmeview'
        # )

    def test_massnahmeview_not_matching_interface(self):
