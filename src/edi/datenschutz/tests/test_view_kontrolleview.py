...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_kontrolleview_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='kontrolleview'
        )
        self.assertTrue(view.__name__ == 'kontrolleview')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in kontrolleview'
        # )

    def test_kontrolleview_not_matching_interface(self):
