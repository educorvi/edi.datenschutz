...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_wordview_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='wordview'
        )
        self.assertTrue(view.__name__ == 'wordview')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in wordview'
        # )

    def test_wordview_not_matching_interface(self):
