...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_vorlage_dsfa_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='vorlage-dsfa-view'
        )
        self.assertTrue(view.__name__ == 'vorlage-dsfa-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in vorlage-dsfa-view'
        # )

    def test_vorlage_dsfa_view_not_matching_interface(self):
