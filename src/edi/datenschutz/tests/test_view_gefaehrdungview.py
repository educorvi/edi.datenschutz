...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_gefaehrdungview_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='gefaehrdungview'
        )
        self.assertTrue(view.__name__ == 'gefaehrdungview')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in gefaehrdungview'
        # )

    def test_gefaehrdungview_not_matching_interface(self):
