...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_create_dsfa_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='create-dsfa'
        )
        self.assertTrue(view.__name__ == 'create-dsfa')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in create-dsfa'
        # )

    def test_create_dsfa_not_matching_interface(self):
