...
threat = SimpleVocabulary((
    SimpleTerm(value=u"angry_employees", token=u"angry_employees", title=u"verärgerte Mitarbeiter"),
    SimpleTerm(value=u"dishonest_employees", token=u"dishonest_employees", title=u"unehrliche Mitarbeiter"),
    SimpleTerm(value=u"intern_employee", token=u"intern_employee", title=u"interner Mitarbeiter"),
    SimpleTerm(value=u"extern_employee", token=u"extern_employee", title=u"Externe Dienstleister"),
...
vulnerability = SimpleVocabulary((
    ...
    SimpleTerm(value=u"business_change", token=u"business_change", title=u"Änderung der Geschäftprozesses"),
